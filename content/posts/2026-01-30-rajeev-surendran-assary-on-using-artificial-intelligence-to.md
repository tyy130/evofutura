---
date: '2026-01-30T19:55:04+00:00'
draft: false
source_name: Argonne National Laboratory
...
A: If you want to build a better battery -- one that stores more energy, stays charged longer or uses a different type of chemistry for supply chain reasons -- then you need to start with the components. You might want to optimize the properties of the electrolyte, which allows t...

[Read the original article](https://www.anl.gov/article/rajeev-surendran-assary-on-using-artificial-intelligence-to-boost-scientific-and-technological)